...
An analysis comparing actual to predicted values, however, reveals that the Poisson model has difficulty accurately capturing the number of claims, particularly at higher claim counts. Most predictions are concentrated in the low range, systematically underestimating actual claim frequencies, which suggests a strong concentration of predictions at the lower end.
