...
Der Overdispersion-Diagnosetest, deviance(poisson_model) / df.residual(poisson_model), ergibt einen Wert von 0,688, was auf keine Overdispersion hinweist (ein Wert nahe 1 wäre ein Indikator für Overdispersion).
Der p-Wert des Devianztests zur Modellgüte beträgt 1 (d. h. p = 1), was bedeutet, dass die Nullhypothese (das Modell passt zu den Daten) nicht abgelehnt werden kann. Das Modell scheint daher gut geeignet, die Daten zu beschreiben, und zeigt keine Überanpassung.
...
### Massnahme 1): Zero-Inflated Poisson (ZIP) model
