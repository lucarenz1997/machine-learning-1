...
To improve the model, checking the training set's class distribution and considering resampling techniques like SMOTE could be performed to further improve the model. Additionally, validating MCC calculations to ensure accuracy, especially for anomalous values, is recommended.
