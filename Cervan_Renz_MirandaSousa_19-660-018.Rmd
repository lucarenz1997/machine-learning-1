...
par(mfrow = c(1, 2))  # Setzt das Layout auf eine einzelne Grafik
# Boxplots
...
A linear model is adapted, whereby CLAIM_PAID_USD_log was not included, as the premium is incurred at the start of the contract and this would therefore not make technical sense. Instead, a bonus-malus system is taken into account by adding AMOUNT_CLAIMS_PAID_log.
