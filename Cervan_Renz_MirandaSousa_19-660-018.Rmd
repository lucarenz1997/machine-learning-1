...
lm_model_no_outliers <- lm(PREMIUM ~ SEX + INSR_TYPE + MAKE + USAGE + TYPE_VEHICLE + INSURED_VALUE + CLAIM_PAID_USD + PROD_YEAR + SEATS_NUM + CCM_TON, data = clean_data_no_outliers)
...
Variablen wie PROD_YEAR und SEATS_NUM zeigen hingegen eine weniger ausgeprägte Schiefe, sodass eine Transformation hier weniger notwendig erscheint. Eine log-Transformation der stark schiefen Variablen wird daher empfohlen, um die Modellgüte weiter zu verbessern.
...
lm_model_log <- lm(LOG_PREMIUM ~ SEX + INSR_TYPE + MAKE + USAGE + TYPE_VEHICLE + 
                              LOG_INSURED_VALUE + LOG_CLAIM_PAID_USD + PROD_YEAR + SEATS_NUM + LOG_CCM_TON, 
...
lm_model_interactions <- lm(LOG_PREMIUM ~ SEX + INSR_TYPE + MAKE * USAGE + TYPE_VEHICLE * USAGE + 
                            LOG_INSURED_VALUE * USAGE + LOG_CLAIM_PAID_USD + PROD_YEAR + SEATS_NUM + 
